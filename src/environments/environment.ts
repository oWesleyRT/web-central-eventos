...
export const environment = {
  ...
  urlCentralEventos: 'http://localhost:3000',
  endPointCentralEventosLogin: '/v1/agent/login',
  endPointCentralEventosAgent: '/v1/agent',
  endPointCentralEventosEvent: '/v1/event'
};
